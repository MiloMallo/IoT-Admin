...
<head>
    ...
    <link rel="stylesheet" href="{{ admin_asset("/vendor/laravel-admin/AdminLTE/morris.js/morris.css") }}">
    ...
    <script src="{{ admin_asset ("/vendor/laravel-admin/AdminLTE/raphael/raphael.min.js") }}"></script>
    <script src="{{ admin_asset ("/vendor/laravel-admin/AdminLTE/morris.js/morris.min.js") }}"></script>
